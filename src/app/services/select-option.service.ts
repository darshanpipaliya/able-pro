...
export class SelectOptionService {
  public static readonly PLAYER_ONE: Array<any> = [
  ...
  private static readonly COUNTRIES: Array<any> = [
  ...
  public cloneOptions(options: Array<any>): Array<any> {
    ...
    loadCharacters(): Observable<Array<any>> {
        return this.loadOptions(SelectOptionService.PLAYER_ONE);
    }

    getCharactersWithDisabled(): Array<any> {
        const characters: Array<any> = this.cloneOptions(SelectOptionService.PLAYER_ONE);
    ...
    loadCountries(): Observable<Array<any>> {
