...
@Component({
  selector: 'app-wireline-p-table',
  templateUrl: './wireline-p-table.component.html',
  styleUrls: ['./wireline-p-table.component.scss'],
  imports: [SharedModule, PrimgModule]
})
export class WirelinePTableComponent implements OnInit {
  ...
  @Output() paramsReset: EventEmitter<any> = new EventEmitter();
  ...
  setCols() {
    ...
    this.cols = [
      ...
      createColumn(3, '190px', true, 'text', 'Vendor', 'VendorAccountName', 'Vendor'),
      createColumn(3, '175px', false, 'text', '', 'ParentVendorAccountName', 'Parent Vendor', 'open'),
      createColumn(3, '250px', false, 'text', '', 'MainAccountNumber', 'Main Account Number', 'open'),
      createColumn(3, '250px', false, 'text', '', 'SubAccountNumber', 'Sub Account Number', 'open'),
      createColumn(3, '250px', false, 'text', '', 'PayableAccountNumber', 'Payable Account Number', 'open'),

      createColumn(4, '250px', true, 'text', 'Product', 'VendorProductTypeName', 'Vendor Product'),
      createColumn(4, '170px', false, 'text', '', 'Service', 'Service', 'open'),
      createColumn(4, '165px', false, 'text', '', 'ServiceType', 'Service Type', 'open'),
      createColumn(4, '155px', false, 'text', '', 'Product', 'Product', 'open'),
      createColumn(4, '190px', false, 'text', '', 'ProductType', 'Product Type', 'open'),

      createColumn(5, '170px', true, 'numberFilter', 'Cost', 'TotalCurrentChargesDisplay', 'Current Charges'),
      createColumn(5, '200px', false, 'numberFilter', '', 'PreviousBillBalanceDisplay', 'Previous Charges', 'open'),
      createColumn(5, '170px', false, 'text', '', 'LastInvoiceDate', 'Last Billing Period', 'open'),
      createColumn(5, '100px', false, 'text', '', 'BillingChargeDisplayText', 'Billing', 'open'),


      createColumn(6, '100px', true, 'text', 'Status', 'InventoryStatusDisplayText', 'Status'),
      createColumn(6, '180px', false, 'dateFilter', '', 'StartDate', 'Service Start Date', 'open'),
      createColumn(6, '190px', false, 'dateFilter', '', 'EndDate', 'Disconnection Date', 'open'),
      createColumn(6, '230px', false, 'numberFilter', '', 'InvoiceCyclesRemaining', 'Invoice Cycles Remaining', 'open'),
      createColumn(6, '190px', false, 'dateFilter', '', 'ContractStartDate', 'Contract Start Date', 'open'),
      createColumn(6, '190px', false, 'dateFilter', '', 'ContractEndDate', 'Contract End Date', 'open'),
      ...
      createColumn(9, '200px', true, 'text', 'People', 'PeopleName', 'Name'),
      createColumn(9, '150px', false, 'text', '', 'PeopleStatusDisplayValue', 'People Status', 'open'),
      createColumn(9, '200px', false, 'text', '', 'PeopleEmail', 'Contact', 'open'),
      createColumn(9, '200px', false, 'text', '', 'EmployeeId', 'Employee ID', 'open'),
      createColumn(9, '200px', false, 'text', '', 'ManagerName', 'Manager', 'open'),
      createColumn(9, '200px', false, 'text', '', 'ManagerEmail', 'Manager Email', 'open'),
      createColumn(9, '200px', false, 'text', '', 'Department', 'Department', 'open'),
      createColumn(9, '200px', false, 'text', '', 'PeopleCustomField1', 'People Custom 1', 'open'),
      createColumn(9, '200px', false, 'text', '', 'PeopleCustomField2', 'People Custom 2', 'open'),
      createColumn(9, '200px', false, 'text', '', 'PeopleCustomField3', 'People Custom 3', 'open'),
      createColumn(9, '200px', false, 'text', '', 'PeopleCustomField4', 'People Custom 4', 'open'),
      createColumn(9, '100px', false, 'text', '', 'PeoplePrimaryDisplay', 'Primary', 'open'),
  ...
  ngOnInit(): void {
   this.needToPassTemId = rolePermission(['CustomerAdmin','CompanyUser', 'CompanyManager', 'CompanyAdmin']);
    ...
    if(this.params?.VendorProductInventoryId) {
      this.wirelineService.getServiceDetail(this.params.VendorProductInventoryId)
        .subscribe(user => {
            if (user?.Success) {
              this.onRowDoubleClick(user.Data)
            }
          })
        }
  }
  ...
  loadNodes(event: any, allOptionsClear = false) {
    ...
    if ((this.finalFilterdArr['advanceFilter'] ?? []).length === 0 && this.payableNumber) {
      const arrData = {
        'filterKey': 'PayableBillingAccountHierarchyId',
