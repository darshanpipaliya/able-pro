...
import { InventoryNotePopupComponent } from 'src/app/inventory/inventory-note-table/inventory-note-popup/inventory-note-popup.component';
import { ErrorWarningPopupComponent } from 'src/app/common/error-warning-popup/error-warning-popup.component';
import { AttachmentRenderer } from 'src/app/inventory/inventory-note-table/attachment-renderer.component';
...
@Component({
  selector: 'app-inventory-note-table-m',
  templateUrl: './inventory-note-table-m.component.html',
  styleUrls: ['./inventory-note-table-m.component.scss'],
  imports: [SharedModule, PrimgModule]
})
export class InventoryNoteTableMComponent implements OnInit {
  @Input() rowData: any;
  ...
  setCols() {
    ...
    if (this.hasSsuperTemUsers) {
      this.cols = [
        ...
        createColumn(6, '120px', false, 'text', '', 'InventoryNoteAttachmentId', 'Attachment'),
