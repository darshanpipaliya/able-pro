...
@Component({
  selector: 'app-add-billing-m',
  templateUrl: './add-billing-m.component.html',
  styleUrls: ['./add-billing-m.component.scss'],
  imports: [SharedModule, PrimgModule, AgGridTableComponent,AgGridModule, BillingLPTableComponent]
})
export class AddBillingMComponent implements OnInit {
  ...
  redirectToCCS(){
    this.redirectTab.emit({redirectIndex: 9});
  }
