...
@Component({
  selector: 'app-charge-code-assignment-ptable',
  templateUrl: './charge-code-assignment-ptable.component.html',
  styleUrls: ['./charge-code-assignment-ptable.component.scss'],
  imports: [SharedModule, PrimgModule]
})
export class ChargeCodeAssignmentPtableComponent implements OnInit, AfterViewInit {
  ...
  setCols() {
    ...
    this.cols = [
      createColumn(1, '250px', true, 'text', 'Charge Code', 'ChargeCodeName', 'Charge Code Name','close', 1, 150, true, true, false),
      createColumn(1, '165px', false, 'text', '', 'ChargeCode', 'Charge Code', 'close', 1, 150, true, true, false),

      createColumn(2, '230px', true, 'text', 'Charge Code Details', 'ChargeCodeType', 'Charge Code Type'),
      createColumn(2, '210px', false, 'text', '', 'ChargeType', 'Charge Type', 'open'),
      createColumn(2, '210px', false, 'text', '', 'ChargeCodeOccurrence', 'Charge Code Occurrence', 'open'),

      createColumn(3, '175px', true, 'text', 'Vendor', 'VendorAccountName', 'Charge Code Vendor'),
      createColumn(3, '190px', false, 'text', '', 'VendorBillingAlias', 'VBA', 'open'),
