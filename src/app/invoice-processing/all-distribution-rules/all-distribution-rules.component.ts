...
@Component({
  selector: 'app-all-distribution-rules',
  templateUrl: './all-distribution-rules.component.html',
  styleUrls: ['./all-distribution-rules.component.scss'],
  imports: [SharedModule, PrimgModule, AgGridTableComponent]
})
export class AllDistributionRulesComponent implements OnInit {
